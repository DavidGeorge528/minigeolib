...
BOOST_AUTO_TEST_CASE_TEMPLATE( test_specialized_initialization, M, tested_types)
{
	...
	test_fixture f;
	tested_matrix m( 
		f.c_array_[0][0], f.c_array_[0][1], f.c_array_[0][2], f.c_array_[0][3],
		f.c_array_[1][0], f.c_array_[1][1], f.c_array_[1][2], f.c_array_[1][3],
		f.c_array_[2][0], f.c_array_[2][1], f.c_array_[2][2], f.c_array_[2][3],
		f.c_array_[3][0], f.c_array_[3][1], f.c_array_[3][2], f.c_array_[3][3]);
	...
	ALGTEST_CHECK_EQUAL_UNIT( f.c_array_[0][3], m(0,3));
	...
	ALGTEST_CHECK_EQUAL_UNIT( f.c_array_[1][3], m(1,3));
	...
	ALGTEST_CHECK_EQUAL_UNIT( f.c_array_[2][3], m(2,3));
	ALGTEST_CHECK_EQUAL_UNIT( f.c_array_[3][0], m(3,0));
	ALGTEST_CHECK_EQUAL_UNIT( f.c_array_[3][1], m(3,1));
	ALGTEST_CHECK_EQUAL_UNIT( f.c_array_[3][2], m(3,2));
